...
const PlayerData = ({ route, navigation }) => {
  ...
  const playerInfo = async () => {
    try {
      const res = await axios.get(
        `https://bfae-91-68-214-149.eu.ngrok.io/data/${player.player}`
      );
      const playerInformation = createPlayerInformation(res.data);
  ...
  const createPlayerInformation = (data) => {
    const playerInformation = {};
    Object.keys(data).forEach((key) => {
      playerInformation[key] = data[key];
    });
        ...
        <View style={styles.containerInfo}>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Playing Time MP"]}
            </Text>
          </View>
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Playing Time Starts"]}
            </Text>
          </View>
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Playing Time Min"]}
            </Text>
          </View>
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Playing Time 90s"]}
            </Text>
          </View>
          <View style={styles.elements}>
            <Text style={styles.label}>Playing Time Gls : </Text>
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance Gls"]}
            </Text>
          </View>
          <View style={styles.elements}>
            <Text style={styles.label}>Playing Time Ast : </Text>
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance Ast"]}
            </Text>
          </View>
          <View style={styles.elements}>
            <Text style={styles.label}>Playing Time G+A-PK : </Text>
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance G+A"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance G-PK"]}
            </Text>
          </View>
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance PK"]}
            </Text>
          </View>
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance PKatt"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance CrdY"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Performance CrdR"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Expected xG"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Expected npxG"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Expected xAG"]}
            </Text>
          </View>
          ...
          <View style={styles.elements}>
            ...
            <Text style={styles.value}>
              {playerInformation &&
                playerInformation[0] &&
                playerInformation[0]["Expected npxG+xAG"]}
            </Text>
          </View>
        </View>
      </ScrollView>
...
//       );
//       const updatedPlayerInfo = {}; // create an empty object to store the updated player information
//       for (const prop in res.data[0]) {
//         updatedPlayerInfo[prop] = res.data[0][prop]; // copy each property of the fetched object to the updated object
//       }
//       setPlayerInformation([updatedPlayerInfo]); // wrap the updated object in an array and set it as the new player information
//     } catch (error) {
//       console.error(error);
//     }
//   };
...
//             <Text style={styles.value}>
//               {playerInformation?.[0]["Progression PrgC"]}
//             </Text>
//           </View>
//           <View style={styles.elements}>
//             <Text style={styles.label}>Playing Time Starts : </Text>
...
//             <Text style={styles.value}>
//               {playerInformation?.[0]["Per 90 Minutes xG"]}
//             </Text>
//           </View>
//           <View style={styles.elements}>
//             <Text style={styles.label}>Per 90 Minutes xAG : </Text>
//             <Text style={styles.value}>
//               {playerInformation?.[0]["Per 90 Minutes xAG"]}
//             </Text>
//           </View>
//           <View style={styles.elements}>
...
//             <Text style={styles.value}>
//               {playerInformation?.[0]["Per 90 Minutes npxG"]}
//             </Text>
//           </View>
//           <View style={styles.elements}>
